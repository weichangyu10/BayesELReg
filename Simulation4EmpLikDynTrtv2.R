...
set.seed(1010101)
xi.test.MAT <- matrix(rnorm((N.test*1000),mean=0,sd=0.25),nrow=1000,ncol=N.test)
...
for(it in 1:200){
  ...
  x2 <- gstar(x1=x1,a1=a1) + rnorm(N,sd=0.25)
  ...
  if(it%%2==0){
    ...
    save.image("Simulation4EmpLikDynTrtRevisionN2000v1.RData")
